...
{
    GlobalCurrent_CoefA = ((float)EEPROM_values[EEPADDR_CALIB_GLOBAL_CURRENT_POINT_1_PHYS_mA] - (float)EEPROM_values[EEPADDR_CALIB_GLOBAL_CURRENT_POINT_2_PHYS_mA]) / ((float)EEPROM_values[EEPADDR_CALIB_GLOBAL_CURRENT_POINT_1_RAW] - (float)EEPROM_values[EEPADDR_CALIB_GLOBAL_CURRENT_POINT_2_RAW]);
...
{
    CurrentOut1_CoefA = ((float)EEPROM_values[EEPADDR_CALIB_CURRENT_OUT1_POINT_1_PHYS_mA] - (float)EEPROM_values[EEPADDR_CALIB_CURRENT_OUT1_POINT_2_PHYS_mA]) / ((float)EEPROM_values[EEPADDR_CALIB_CURRENT_OUT1_POINT_1_RAW] - (float)EEPROM_values[EEPADDR_CALIB_CURRENT_OUT1_POINT_2_RAW]);
...
{
    CurrentOut2_CoefA = ((float)EEPROM_values[EEPADDR_CALIB_CURRENT_OUT2_POINT_1_PHYS_mA] - (float)EEPROM_values[EEPADDR_CALIB_CURRENT_OUT2_POINT_2_PHYS_mA]) / ((float)EEPROM_values[EEPADDR_CALIB_CURRENT_OUT2_POINT_1_RAW] - (float)EEPROM_values[EEPADDR_CALIB_CURRENT_OUT2_POINT_2_RAW]);

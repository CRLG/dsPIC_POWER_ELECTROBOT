...
typedef enum {
    ...
    REG_STOR_PGED,
    REG_STOR_PGEC,
    REG_CALIB_BATTERY_VOLTAGE_RAW_POINT_1,
    REG_CALIB_BATTERY_VOLTAGE_PHYS_POINT_1,
    REG_CALIB_BATTERY_VOLTAGE_RAW_POINT_2,
    REG_CALIB_BATTERY_VOLTAGE_PHYS_POINT_2,
    REG_CALIB_GLOBAL_CURRENT_RAW_POINT_1,
    REG_CALIB_GLOBAL_CURRENT_PHYS_POINT_1,
    REG_CALIB_GLOBAL_CURRENT_RAW_POINT_2,
    REG_CALIB_GLOBAL_CURRENT_PHYS_POINT_2,
    REG_CALIB_CURRENT_OUT1_RAW_POINT_1,
    REG_CALIB_CURRENT_OUT1_PHYS_POINT_1,
    REG_CALIB_CURRENT_OUT1_RAW_POINT_2,
    REG_CALIB_CURRENT_OUT1_PHYS_POINT_2,
    REG_CALIB_CURRENT_OUT2_RAW_POINT_1,
    REG_CALIB_CURRENT_OUT2_PHYS_POINT_1,
    REG_CALIB_CURRENT_OUT2_RAW_POINT_2,
    REG_CALIB_CURRENT_OUT2_PHYS_POINT_2,
